...
public class Shapes{
    ...
    // It takes two sets of x,y-coordinates as parametres. 
    // The distance is defined as the square root of the squared values of the distances between x and y respectively. 
    ...
    // Method that returns center as a string. 
    // The method for calculating the center is defined in the classes of the individual shapes.
    public String getCenter(){
        return Arrays.toString(center);
    }
    
    // Method that calculates the euclidian distance between two shapes. 
    // It takes another shape as parameter. 
    // It calls the distTwoPointsMethods, where the coordinates of two shapes centres used as parametres. 
